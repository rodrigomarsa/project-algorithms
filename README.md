...
O objetivo do projeto foi treinar a capacidade de resolução de diferentes problemas, utilizando os conhecimentos de complexidade de algoritmos, recursividade e algoritmos de ordenação e busca.

<details>
  <summary><strong>👨‍💻 O que foi desenvolvido</strong></summary><br />

Neste projeto foi resolvido problemas e otimizado algoritmos desenvolvendo a capacidade de implementar soluções para os mais diversos problemas do dia a dia!
...
<details>
  ...
  Este repositório é composto pela pasta `challenges` que contém todos os arquivos do projeto.

  Cada arquivo `.py`, dentro da pasta `challenges` representa um desafio, ou seja, os arquivos não têm ligação uns com os outros.
  Logo, os problemas foram resolvidos de forma separada.
</details>
